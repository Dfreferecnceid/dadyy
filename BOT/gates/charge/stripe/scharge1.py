...
# Import proxy system - ADDED FROM SHOPIFY0.PY
try:
...
class StripeCharge1Checker:
    def __init__(self, user_id=None):
        ...
        # ADDED: Initialize with proxy if available - FROM SHOPIFY0.PY
...
<b>Checking card... Please wait.</b>"""
    ...
    # ADDED: Modified make_request to include proxy support - FROM SHOPIFY0.PY
    async def make_request(self, client, method, url, **kwargs):
        """Make request with proxy support and error handling - OPTIMIZED"""
        try:
            ...
            # Update proxy stats if proxy was used - FROM SHOPIFY0.PY
            ...
            # Update proxy stats on failure - FROM SHOPIFY0.PY
            if self.current_proxy and PROXY_ENABLED:
                mark_proxy_failed(self.current_proxy)
    ...
    # ADDED: Pass user_id to constructor - FROM SHOPIFY0.PY
    async def check_card(self, card_details, username, user_data):
        ...
        try:
            ...
            # ADDED: Create HTTP client with proxy support - FROM SHOPIFY0.PY
            client_params = {
                'timeout': 30.0,
            ...
            if self.current_proxy:
                ...
                logger.info(f"🔄 Using proxy: {self.current_proxy[:50]}...")
...
<b>Checking card... Please wait.</b>"""
        ...
        # MODIFIED: Create checker instance with user_id - FROM SHOPIFY0.PY
